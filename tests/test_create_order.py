...
class TestCreateOrder:
    ...
    def test_create_order_with_auth_and_ingredients(self, create_user):
        ingredient_ids = helpers.get_ingredient_ids()
        response = helpers.create_order(create_user["accessToken"], [ingredient_ids[0], ingredient_ids[1], ingredient_ids[2]])
    ...
    def test_create_order_without_auth(self):
        ingredient_ids = helpers.get_ingredient_ids()
        response = helpers.create_order(None, [ingredient_ids[1], ingredient_ids[2], ingredient_ids[3]])
    ...
    def test_create_order_without_ingredients(self, create_user):
        response = helpers.create_order(create_user["accessToken"], [])
    ...
    def test_create_order_with_invalid_hash(self, create_user):
        response = helpers.create_order(create_user["accessToken"], ["invalid_hash"])
